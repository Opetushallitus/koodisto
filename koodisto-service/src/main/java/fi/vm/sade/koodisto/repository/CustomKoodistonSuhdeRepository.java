...
public interface CustomKoodistonSuhdeRepository {

    List<KoodistonSuhde> getRelations(KoodistoUriAndVersioType ylaKoodisto,
                                      List<KoodistoUriAndVersioType> alaKoodistos,
                                      SuhteenTyyppi st);

    void copyRelations(KoodistoVersio old, KoodistoVersio fresh);

    void deleteRelations(KoodistoUriAndVersioType ylaKoodisto,
                         List<KoodistoUriAndVersioType> alaKoodistos,
                         SuhteenTyyppi st);
