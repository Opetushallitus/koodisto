...
public class KoodistoChangesServiceImplTest {
    ...
    public void usesCodesVersionThatIsClosestToGivenDateForComparison() {
        assertGivenResultWithDateQuery(dateFromLong(20050000), false);
    }
    ...
    private KoodistoChangesDto givenResultWithMultipleKoodistoVersiosForDateQuery(LocalDateTime date, boolean compareToLatestAccepted, KoodistoVersio... versios) {
